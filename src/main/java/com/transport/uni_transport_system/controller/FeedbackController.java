...
import com.transport.uni_transport_system.service.FeedbackService;
...
public class FeedbackController {
    ...
    public void bindForm(WebDataBinder binder) {
        ...
        // These forms accept request parameters, never HTTP headers as business data.
        if (binder instanceof ExtendedServletRequestDataBinder servletBinder) {
            servletBinder.setHeaderPredicate(header -> false);
        }
    }
